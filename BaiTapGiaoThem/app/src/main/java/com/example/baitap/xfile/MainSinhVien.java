package com.example.baitap.xfile;
        ...
        try {
            if (Xfile.kiemtratontai(MainSinhVien.this, TENFILE)) {
                ...
                if (list_ == null || list_.isEmpty()) {
                    ...
                    list_.add(new SinhVien(1, "Nguyễn Văn A", "Nam", R.drawable.buncha));
                    list_.add(new SinhVien(2, "Nguyễn Thị B", "Nu", R.drawable.buncha));
                    Xfile.ghifile(MainSinhVien.this, TENFILE, list_);
                }
            } else {
                list_ = new ArrayList<>();
                list_.add(new SinhVien(1, "Nguyen Van A", "Nam", R.drawable.buncha));
                list_.add(new SinhVien(2, "Nguyễn Thị B", "Nu", R.drawable.buncha));
                Xfile.ghifile(MainSinhVien.this, TENFILE, list_);
            }
        } catch (Exception e) {
